...
class BuyPageController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    func getProductsFromServer(){
        ...
        var currProduct = Product(title: "Product Title1", description: "Description of product1")
        var currProduct2 = Product(title: "Product Title2", description: "Description of product2" )
